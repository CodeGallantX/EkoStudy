            ...
            <form action="" method="post" className='flex flex-col gap-3 lg:gap-6'>
                <div className="flex flex-row items-center justify-between">
                    <fieldset className="flex flex-col items-start justify-center gap-1">
                        ...
                        <input className="w-full border border-solid py-3 px-3 rounded border-[#22283170] outline-none focus:border-none focus:ring-1 focus:ring-[#92B76D] text-[#6c8b4c]" type="text" name="firstname" id="firstname" placeholder='Kia' required />
                    </fieldset>
                    <fieldset className="flex flex-col items-start justify-center gap-1">
                        <label className='text-[#222831c6]' htmlFor="email">Last Name</label>
                        <input className="w-full border border-solid py-3 px-3 rounded border-[#22283170] outline-none focus:border-none focus:ring-1 focus:ring-[#92B76D] text-[#6c8b4c]" type="text" name="lastname" id="lastname" placeholder='Smith' required />
                    </fieldset>
                </div>
                    <fieldset className="flex flex-col items-start justify-center gap-1">
                ...
                <button className="w-full text-xl font-semibold py-4 rounded bg-[#92B76D] hover:bg-[#ffca0d] transition duration-300 ease-in-out" type="submit">SIGN UP</button>
            </form>
            <div className='mt-4'>
