...
const FooterBanner = () => {
  return (
    <div className="relative px-10 xl:px-24 translate-y-24 lg:translate-y-16 xl:translate-y-32">
      <div
       className="relative flex flex-col lg:flex-row items-center justify-between px-5 sm:px-6 py-4 lg:px-8 lg:py-8 xl:px-20 xl:py-20 bg-cover bg-fixed no-repeat"
