    ...
    <>
          ...
          <ul className='flex flex-row gap-8'>
            ...
            >
              ...
              <ul className={`absolute left-0 -ml-4 mt-8 w-40 bg-[#4c5f4e] text-white px-5 shadow-lg z-30 border-t-2 border-t-[#ffca0d] border-solid transition-all duration-300 ease-in-out transform ${isResourcesOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
                <li className="py-2 hover:text-[#ffca0d] transition duration-200">
                  <Link to="/resources/book-store" onClick={hideSideBar}>Book Store</Link>
                </li>
                <li className="py-2 hover:text-[#ffca0d] transition duration-200">
                  <Link to="/resources/notes-and-pqs" onClick={hideSideBar}>Notes & Past Questions</Link>
                </li>
                <li className="py-2 hover:text-[#ffca0d] transition duration-200">
                  <Link to="/resources/cbt" onClick={hideSideBar}>CBT</Link>
                </li>
                <li className="relative py-2 group hover:text-[#ffca0d] transition duration-200">
                  <Link to="/resources/ai-chatbot" onClick={hideSideBar}>AI ChatBot <span className="absolute group-hover:text-white right-0 top-0 text-[8px] bg-[#ffca0d] rounded-xl py-1 px-2">New</span></Link>
                </li>
              </ul>
            </li>
            <li className="text-white cursor-pointer font-bold py-8">
      ...
      {isSidebarVisible && (
        <>
          ...
          />
          <ul
            className={`lg:hidden fixed top-0 left-0 h-full bg-[#4c5f4e] w-2/3 flex flex-col items-start p-4 transition-transform duration-300 ease-in-out z-40 transform ${isSidebarVisible ? 'translate-x-0' : '-translate-x-full'}`}
          > 
